...
mixin _$User {
  ...
  dynamic get userAdmin => throw _privateConstructorUsedError;
...
class _$_User implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, createdAt: $createdAt, updatedAt: $updatedAt, email: $email, name: $name, phoneNumber: $phoneNumber, username: $username, gender: $gender, dateOfBirth: $dateOfBirth, image: $image, userAdmin: $userAdmin)';
  }
...
abstract class _User implements User {
  const factory _User(
      ...
      required final dynamic userAdmin}) = _$_User;
